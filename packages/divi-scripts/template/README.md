...
If you run `npm test` and the console gets stuck after printing `divi-scripts test --env=jsdom` to the console there might be a problem with your [Watchman](https://facebook.github.io/watchman/) installation as described in [facebook/create-react-app#713](https://github.com/facebook/create-react-app/issues/713).
...
If you have ideas for more “How To” recipes that should be on this page, [let us know](https://github.com/facebook/create-divi-extension/issues) or [contribute some!](https://github.com/facebook/create-divi-extension/edit/master/packages/divi-scripts/template/README.md)
