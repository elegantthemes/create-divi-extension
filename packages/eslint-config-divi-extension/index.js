  ...
  rules: {
    ...
    'no-restricted-properties': [
      ...
      },
      {
        ...
        property: 'import',
        message:
          'Please use import() instead. More info: https://github.com/elegantthemes/create-divi-extension/blob/master/packages/divi-scripts/template/README.md#code-splitting',
      },
    ],
    'getter-return': 'warn',
